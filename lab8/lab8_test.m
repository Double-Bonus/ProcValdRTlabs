...
[y_el, t_el] = get_euler_apox_f(fun_array(fun_nr), h, SIM_TIME);
[y_fixed, t_fix] = get_euler_fixed_apox_f(fun_array(fun_nr), h, SIM_TIME);
[y_mod, t_mod] = get_euler_mod_apox_f(fun_array(fun_nr), h, SIM_TIME);
[y_run, t_run] = get_rung_kut_apox_f(fun_array(fun_nr), h, SIM_TIME);
